...
if(!defined('INITIALIZED'))
   ...
   $bg_color     = imagecolorallocate($im,234,169,0); 
   $font_color   = imagecolorallocate($im,53,53,54); 
   $grid_color   = imagecolorallocate($im,117,117,117); 
   $border_color = imagecolorallocate ($im, 54, 54, 56); 
