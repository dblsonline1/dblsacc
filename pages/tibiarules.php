...
5. Other
a) When you accept those rules, you agree to receive advertising email, facebook and sms to a number with which you will be performed by a donation to the server.

A violation of the DBNS Rules may lead to temporary banishment of characters and accounts. In severe cases removal or modification of character skills, attributes and belongings, as well as the permanent removal of accounts without any compensation may be considered. The sanction is based on the seriousness of the rule violation and the previous record of the player. It is determined by the gamemaster imposing the banishment.
